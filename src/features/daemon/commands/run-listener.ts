import { createSlackListener } from '../../slack';
import { RedisService } from '../../../shared/infra/redis/RedisService';
import { SlackListenerDaemon } from '../application/SlackListenerDaemon';
import { DaemonStatusService } from '../application/DaemonStatusService';
...
export async function runListenerCommand(): Promise<void> {
  ...
  const slack = createSlackListener(config.slack_bot_token, config.slack_app_token);
